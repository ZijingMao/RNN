...
cmd:option('-seq_length',512,'number of timesteps to unroll for')
...
cmd:option('-train_frac',0.995,'fraction of data that goes into train set')
cmd:option('-val_frac',0.005,'fraction of data that goes into validation set')
...
cmd:option('-savefile','tudou','filename to autosave the checkpont to. Will be inside checkpoint_dir/')
-- GPU/CPU
